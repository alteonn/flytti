...
import { InternationalMovingFormData, initialInternationalMovingFormData } from '@/types/international-moving';
...
export function InternationalMovingForm() {
  ...
  const updateStepData = (step: keyof InternationalMovingFormData, data: Partial<InternationalMovingFormData[keyof InternationalMovingFormData]>) => {
    setFormData((prev) => ({
      ...prev,
      [step]: {
        ...prev[step],
  ...
  return (
    <FormLayout
      title="Få hjälp med utlandsflytt"
      ...
      successDescription="Vi har mottagit din förfrågan och kommer inom kort att kontakta dig med offerter från våra kvalitetssäkrade flyttfirmor som specialiserar sig på internationella flyttar."
    >
      {renderStep()}
    </FormLayout>
  );
