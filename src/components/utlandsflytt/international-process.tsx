...
const steps = [
  {
    ...
    description: 'Fyll i vårt formulär med information om din internationella flytt.',
  },
  {
    icon: FileText,
    title: 'Få skräddarsydda offerter',
    description: 'Specialiserade internationella flyttfirmor kontaktar dig med anpassade lösningar.',
  },
  {
    icon: CheckCircle,
...
export function InternationalProcess() {
  return (
      ...
      <div className="container mx-auto px-4 relative">
        ...
        >
          <h2 className="text-4xl md:text-5xl font-serif mb-6">
            Så fungerar utlandsflytt
          </h2>
          <p className="text-lg text-text-light">
            En smidig process anpassad för internationella flyttar
          </p>
        </motion.div>
