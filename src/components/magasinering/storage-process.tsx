...
const steps = [
  {
    ...
    description: 'Fyll i vårt formulär med information om din magasinering.',
  },
  {
    icon: FileText,
    title: 'Få skräddarsydda offerter',
    description: 'Magasineringsföretag kontaktar dig med anpassade lösningar.',
  },
  {
    icon: CheckCircle,
      ...
      <div className="container mx-auto px-4 relative">
        ...
        >
          ...
          <p className="text-lg text-text-light">
            En smidig process för att hitta rätt magasinering
          </p>
        </motion.div>
