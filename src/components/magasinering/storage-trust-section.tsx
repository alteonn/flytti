...
const features = [
  {
    ...
    description: 'Endast verifierade och försäkrade magasineringsföretag',
  },
  {
    icon: Lock,
    title: 'Säker förvaring',
    description: 'Moderna säkerhetssystem och övervakning',
  },
  {
    icon: Clock,
    title: 'Tillgänglighet',
    description: 'Åtkomst till ditt förråd när det passar dig',
  },
];

export function StorageTrustSection() {
  return (
      ...
      <div className="container mx-auto px-4">
        ...
        >
          ...
          <p className="text-lg text-text-light">
            Vi samarbetar endast med erfarna och professionella magasineringsföretag
            som levererar högsta kvalitet.
          </p>
        </motion.div>
