...
const benefits = [
  {
    icon: Clock,
    title: 'Minimera avbrottstiden',
    description: 'Effektiv planering och genomförande för minimal verksamhetspåverkan',
  },
  {
    icon: PiggyBank,
    title: 'Kostnadseffektivt',
    description: 'Konkurrenskraftiga priser genom smart upphandling',
  },
  {
    icon: Shield,
    title: 'Säker hantering',
    description: 'Specialistkompetens för kontor och känslig utrustning',
  },
  {
    icon: Users,
    title: 'Erfarna partners',
    description: 'Tillgång till Sveriges mest erfarna kontorsflyttare',
  },
];
    ...
    <section className="py-24 relative overflow-hidden bg-white">
      <div className="container mx-auto px-4">
        <div className="max-w-3xl mx-auto text-center mb-16">
          ...
          >
            Professionell{' '}
            <span className="text-primary">kontorsflytt</span>
          </motion.h2>
          <motion.p
            initial={{ opacity: 0, y: 20 }}
            whileInView={{ opacity: 1, y: 0 }}
          ...
          >
            Vi hjälper er hitta rätt flyttfirma för er kontorsflytt. Jämför offerter och få 
            skräddarsydda lösningar för just era behov.
          </motion.p>
          <Button 
            size="lg" 
