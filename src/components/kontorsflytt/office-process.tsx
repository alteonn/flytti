...
const steps = [
  {
    icon: MessageSquare,
    title: 'Beskriv era behov',
    description: 'Fyll i vårt formulär med information om er kontorsflytt.',
  },
  {
    icon: FileText,
    title: 'Få skräddarsydda offerter',
    description: 'Specialiserade kontorsflyttare kontaktar er med anpassade lösningar.',
  },
  {
    icon: CheckCircle,
    title: 'Välj bästa alternativet',
    description: 'Jämför offerter och välj den partner som bäst möter era behov.',
  },
];
      ...
      <div className="container mx-auto px-4 relative">
        ...
        >
          <h2 className="text-4xl md:text-5xl font-serif mb-6">
            Så fungerar kontorsflytt
          </h2>
          <p className="text-lg text-text-light">
            En smidig process anpassad för företag
          </p>
        </motion.div>
