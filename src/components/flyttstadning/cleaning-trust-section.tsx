...
const features = [
  {
    ...
    description: 'Endast verifierade och försäkrade städfirmor',
  },
  {
    icon: CheckCircle,
    title: 'Nöjd-kund-garanti',
    description: 'Städningen ska uppfylla alla överenskomna krav',
  },
  {
    icon: Clock,
    title: 'Flexibla tider',
    description: 'Städning när det passar dig och din flytt',
  },
];

export function CleaningTrustSection() {
  return (
      ...
      <div className="container mx-auto px-4">
        ...
        >
          ...
          <p className="text-lg text-text-light">
            Vi samarbetar endast med erfarna och professionella städfirmor
