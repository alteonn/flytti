...
import { ArrowRight, Clock, PiggyBank, Shield, Sparkles } from 'lucide-react';
    ...
    <section className="py-24 relative overflow-hidden bg-white">
      <div className="container mx-auto px-4">
        <div className="max-w-3xl mx-auto text-center mb-16">
          ...
          >
            Professionell{' '}
            <span className="text-primary">flyttstädning</span>
          </motion.h2>
          <motion.p
            initial={{ opacity: 0, y: 20 }}
            whileInView={{ opacity: 1, y: 0 }}
          ...
          >
            Vi hjälper dig hitta rätt städfirma för din flyttstädning. Jämför offerter och få 
